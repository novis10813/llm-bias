...
- `test_entity_to_dial_heldout_transfer.py`：Entity-to-Dial held-out transfer V1 的 2024 S&P 500 cohort/provenance、selection/evaluation split、sector-within 與 cross-sector pairing、random 8D controls、fixed-margin ratio/bootstrap analysis、compact artifacts、fake-model workflow、smoke 與 CLI；不載 checkpoint、不需 GPU。
