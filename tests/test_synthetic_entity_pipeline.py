...
from llm_bias.core.directions import OnlineDirection
...
def test_online_direction_sums_are_cpu_float32():
 direction=OnlineDirection(torch.zeros(3,dtype=torch.float32),torch.zeros(3,dtype=torch.float32))
