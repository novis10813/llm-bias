...
沿用 [proposal.md §2](proposal-phase-abc.md#2-定義)、[proposal-phase-d.md §2](proposal-phase-d.md#2-新增術語定義)、[proposal-phase-e.md §2](proposal-phase-e.md#2-術語定義) 的術語。新增：
