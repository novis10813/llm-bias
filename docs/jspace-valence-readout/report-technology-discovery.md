...
這些 candidates 已由
[token causal screen V1](../jspace-token-experiments/proposal-v1.md) 的 `run-token-screen`
...
axis。兩版差異見 [J-space token experiment versions](../jspace-token-experiments/README.md)。
