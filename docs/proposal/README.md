...
This directory contains versioned research design and planning documents. It is
not the source of CLI instructions, artifact schemas, or dated experiment
results; those remain in the implementation and reproducibility documents under
[`docs/`](..).
