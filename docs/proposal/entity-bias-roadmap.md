...
| [Entity-to-Dial](../entity-to-dial/report.md) | Phase A–F completed and closed; L15 k=8 effect ratio 0.983 in tested directions; F1 additivity fails. | Residual-state transfer is a better description than a single dial, entity token or additive two-channel account; not held-out generalisation, complete circuit recovery or selective gap reduction. |
