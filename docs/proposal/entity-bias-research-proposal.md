...
| [Entity-to-Dial report](../entity-to-dial/report.md) | In the tested Qwen3.5-4B population/directions, L15 k=8 projection recovers a 0.983 effect ratio; Phase F additivity fails. This supports a residual-state account over a single dial, but neither establishes held-out subspace generalisation nor complete circuit recovery. |
