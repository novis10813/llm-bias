...
**Roadmap 對應**：原始 M5 — Implement and evaluate selective intervention；
原始 research proposal §4.4 候選形式 #3（low-rank projection/subtraction from
an entity-difference subspace）。目前規劃見
[roadmap](../../proposal/entity-bias-roadmap.md#selective-intervention-remains-a-separate-research-line)
與 [research program](../../proposal/entity-bias-research-proposal.md)；文件整併不改本 V1 協議。
