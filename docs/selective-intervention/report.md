...
**檔案狀態**：本報告對應 protocol
[`docs/selective-intervention/details/proposal-v1.md`](details/proposal-v1.md)（Rev 1 frozen；
...
specificity 對照均已記錄。** Paper provenance 與版本矩陣見 [全線入口](proposal.md)。
...
- **Protocol**：run 記錄路徑 `docs/selective-intervention/proposal-v1.md`（protocol rev 1，frozen）；目前文件位置為 [details/proposal-v1.md](details/proposal-v1.md)，歷史 artifacts 不回寫。
