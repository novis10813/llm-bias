...
上游為 [定位 smoke](../../financial-soundness-localization/details/report-smoke.md) 的 financial-smoke-localization-v1。程式核對來源 manifest、compact artifacts、模型及 tokenizer identity，使用其 24 個 L0 候選，在未參與定位的 12 對 evidence/comparison 題上完成驗證。
