...
使用 [全層定位](../financial-soundness-localization/report-exploratory-v1.md) 的 72 個候選，在 calibration/held-out 共 48 對 evidence/comparison 題上執行 clean、0.5/0.0 縮放、同層隨機對照、同題恢復及雙向 donor 替換，共 48,384 筆記錄。GPU0 上耗時 54 分 43 秒。
