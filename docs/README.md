...
| [jspace-token-experiments](jspace-token-experiments/report.md) → [Evidence-insensitivity](evidence-insensitivity/proposal.md) | 資料／產物依賴 | 零證據 header-only 模板與強 sell prior 觀察（6 tickers）；零證據量測擴到 503 家。 [依據](evidence-insensitivity/details/proposal-phase1.md) |
