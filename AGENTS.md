...
- [Balanced Evidence Gap（entity-induced decision gap 行為確認）](docs/balanced-evidence-gap/proposal.md)（Phase 1 proposed；16 家 test-split 公司，多空平衡證據，named vs. anonymous margin gap；Phase 2 中間層 path patching 待 Phase 1 確認後另立研究線）
