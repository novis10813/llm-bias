...
- [Balanced Evidence Gap（entity-induced decision gap 行為確認）](docs/balanced-evidence-gap/proposal.md) / [Phase 1 報告](docs/balanced-evidence-gap/report-phase1.md)（Phase 1 completed；三判準全過：公司間 IQR 1.375 nats、named-vs-anonymous gap +0.432 CI [+0.350, +0.518]、16/128 翻轉）/ [Phase 2 proposal](docs/balanced-evidence-gap/proposal-phase2.md)（Rev 1；cross-entity probe ＋ entity-state layer sweep ＋ component attribution；實作與 smoke 完成，正式 run 待執行）
