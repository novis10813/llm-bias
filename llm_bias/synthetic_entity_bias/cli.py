...
def main():
 ...
 root=run_pipeline(constituents=args.constituents,model_path=args.model,lens_path=args.lens,artifact_root=args.artifact_root,dataset=args.dataset,run_id=args.run_id,model=model,tokenizer=tokenizer,seed=args.seed,max_seq_len=args.max_seq_len)
 print(root)
