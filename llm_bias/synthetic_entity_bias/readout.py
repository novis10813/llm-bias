...
def score_distribution(logits: torch.Tensor, label_token_ids: list[int]|dict[str,int], *, residual: torch.Tensor|None=None, final_norm: Any|None=None) -> dict[str,Any]:
 ...
 if residual is None: raise ValueError("effective temperature requires the transported answer residual")
